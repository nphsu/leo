...
mixin ProductsModel on ConnectedProductsModel {
  ...
  Future<bool> deleteProduct() {
    ...
    notifyListeners();
    return http
        .delete('xxx/products/${deletedProductId}.json')
  ...
  Future<Map<String, dynamic>> authenticate(String email, String password,
    ...
    if (mode == AuthMode.Login) {
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/verifyPassword?key=AIzaSyCGO_y8Y9SXeXg9VenXcy-nrIVpf7nQwaQ',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    } else {
      response = await http.post(
          'https://www.googleapis.com/identitytoolkit/v3/relyingparty/signupNewUser?key=AIzaSyCGO_y8Y9SXeXg9VenXcy-nrIVpf7nQwaQ',
          body: json.encode(authData),
          headers: {'Content-Type': 'application/json'});
    }
    final Map<String, dynamic> responseData = json.decode(response.body);
